...
Ordinary least squares (OLS) is a type of method for estimating the conditional betas in a linear equation. The betas are chosen based on the following minimization problem:
$$
...
>>>>>>> 773f3e565704efbe3eaacd51d534f7135c187440
$$
...
<<<<<<< HEAD
## Proof that mean minimizes sum of squares
=======
