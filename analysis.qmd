...
plot_summs(qr10, qr30, qr50, qr70, qr90, se="iid", ci=.95, omit.coefs = c("(Intercept)", "as.factor(LotShape)IR2", "as.factor(LotShape)IR3", "as.factor(LotShape)Reg", "as.factor(Foundation)CBlock", "as.factor(Foundation)PConc", "as.factor(Foundation)Slab", "as.factor(Foundation)Stone", "as.factor(Foundation)Wood", "TotRmsAbvGrd")) #, qr50, qr70, qr90)
plot_summs(qr10, qr30, qr50, qr70, qr90, se="iid", ci=.95, omit.coefs = c("(Intercept)", "as.factor(LotShape)IR2", "as.factor(LotShape)IR3", "as.factor(LotShape)Reg", "as.factor(Foundation)CBlock", "as.factor(Foundation)PConc", "as.factor(Foundation)Slab", "as.factor(Foundation)Stone", "as.factor(Foundation)Wood", "GrLivArea", "LotArea")) #, qr50, qr70, qr90)
plot_summs(qr10, qr30, qr50, qr70, qr90, se="iid", ci=.95, omit.coefs = c("(Intercept)", "GrLivArea", "LotArea", "TotRmsAbvGrd")) 
