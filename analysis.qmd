...
#GrLivArea + LotArea + TotRmsAbvGrd + as.factor(LotShape) + as.factor(Foundation)

| Quantile |    GrLivArea | TotRmsAbvGrd |LotArea     |LotShape_IR2      |LotShape_IR3|
|---------|:--------------|-------------:|:----------:|:----------------:|              
| 10      | Significant   |Not Significant|Significant|Not Significant   |
| 25      | Significant   |Significant   |Significant |Not Significant   |
| 50      | Significant   |Significant   |Significant |Not Significant   |
| 75      | Significant   |Significant   |Significant |                  |
| 90      | Significant   |Significant   |Significant |                  |