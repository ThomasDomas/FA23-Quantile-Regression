...
\end{equation}
where $$\{x_t: t=1,...,T\}$$ denotes a sequence (row) of K-vectors of a known design matrix and $$\{y_t: t=1,...,T\}$$ is a random sample on the regression process $u_t = y_t - x_t\beta$
